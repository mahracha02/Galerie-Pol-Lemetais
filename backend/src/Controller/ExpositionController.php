...
final class ExpositionController extends AbstractController
{
    ...
    public function getAllExpositions(ExpositionRepository $expositionRepository): JsonResponse
    {
        ...
        $data = array_map(function (Exposition $expo) use ($formatter) {
            return [
                ...
                'visite_virtuelle_url' => $expo->getVisiteVirtuelleUrl() ? $expo->getVisiteVirtuelleUrl() : null,
                'image' => $this->getPhotoUrl($expo->getImage(), 'expositions'),
    ...
    public function getExposition(Exposition $exposition): JsonResponse
    {
        ...
        return $this->json([
            ...
            'date_debut' => $exposition->getDateDebut() ? $exposition->getDateDebut()->format('Y-m-d') : null,
            'date_fin' => $exposition->getDateFin() ? $exposition->getDateFin()->format('Y-m-d') : null,
            'visite_virtuelle_url' => $exposition->getVisiteVirtuelleUrl() ? $exposition->getVisiteVirtuelleUrl() : null,
