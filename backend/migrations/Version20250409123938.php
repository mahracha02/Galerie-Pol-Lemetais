 ...
 */
final class Version20250409123938 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE exposition ADD CONSTRAINT FK_BC31FD13F9C86A29 FOREIGN KEY (artiste_principal_id) REFERENCES artiste (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
